...
{
    public class Sphere3D : Object3D
    {
        ...
        public override void Generate(List<double> parameterList)
        {
            ...
            double deltaLatitude = Math.PI / (double)(numberOfLatitudePoints-1);
            double deltaLongitude = 2 * Math.PI / (double)numberOfLongitudePoints;

            List<List<List<double>>> pointList = new List<List<List<double>>>();  // Remove?
